...
The [composed TensorRT deployment command](benchmarks.md#composed-tensorrt-deployment-evaluation)
...
| Continuous validation/reporting | CPU safeguards, optional GPU training workflow, visible job summaries and 90-day artifacts | Remote execution of the composed TensorRT deployment command; durable cross-device result history and acceptance gates |
