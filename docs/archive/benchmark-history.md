> Historical experiment record, retained for provenance. Some earlier conclusions
> were superseded by later measurements. Use [current findings](../benchmarks.md)
> and the [branch roadmap](../quantization-roadmap.md) for current decisions.
> Historical `tmp-*` paths refer to the retained local evidence archive described
> in [artifact retention](../quantization-artifacts.md); disposable binaries may
> have been removed. This file is not a list of currently available artifacts.
...
See [the reproduction commands](../../dev/benchmarks/training.md#integrated-qt-dataset-profiles).
...
Use [`qt-dense`](../../dev/benchmarks/training.md#dense-real-data-qt-comparison) to run
...
The shared [`qt-large-batch` profile](../../dev/benchmarks/training.md#multi-seed-large-batch-comparison)
...
The shared [loader probe](../../dev/benchmarks/training.md#worker-batch-assembly) now
...
The [file-backed reader probe](../../dev/benchmarks/training.md#streaming-image-reader-comparison)
...
[benchmark runner guide](../../dev/benchmarks/training.md#cuda-graph-comparison).
...
bash dev/check.sh test tests/quantization/test_quantized_training.py -k fresh_kernel_tuning
```
...
[the shared command](../../dev/benchmarks/training.md#model-and-optimizer-graph-comparison)
...
[benchmark guide](../../dev/benchmarks/training.md#representative-efficientnetv2-configuration).
...
[target-machine commands](../../dev/benchmarks/inference.md#portable-onnx-inference-measurements).
...
[developer guide](../../dev/benchmarks/inference.md#tensorrt-calibration-candidate).
...
[command documentation](../../dev/benchmarks/inference.md#paired-inference-quality-pipeline).
...
The [command guide](../../dev/benchmarks/inference.md#single-process-onnx-cpu-memory-probe)
...
Reproduction uses the maintained [CPU recipe](../../dev/benchmarks/inference.md#cpu-specific-qdq-candidate-for-efficientnetv2),
...
[command guide](../../dev/benchmarks/inference.md#composed-cpu-deployment-comparison).
...
See the [command guide](../../dev/benchmarks/inference.md#large-head-training-capacity-command).
...
hierarchical outputs. The [command](../../dev/benchmarks/training.md#training-predictions-to-paired-quality-evaluation)
...
See the [commands and scope](../../dev/benchmarks/inference.md#maintained-image-input-preparation).
...
[input schema and composed commands](../../dev/benchmarks/inference.md#maintained-full-dataset-prediction-collection).
...
See the [input contract and commands](../../dev/benchmarks/inference.md#maintained-paired-quality-comparison).
...
[commands and measurement scope](../../dev/benchmarks/inference.md#maintained-paired-tensorrt-timing-command).
...
[manifest and commands](../../dev/benchmarks/inference.md#maintained-onnx-calibration-command).
...
[command and environment instructions](../../dev/benchmarks/inference.md#maintained-tensorrt-build-and-inspection-command).
...
five-metric quality checks. See the [command documentation](../../dev/benchmarks/inference.md#isolated-tensorrt-memory-command).
...
The [command documentation](../../dev/benchmarks/inference.md#composed-tensorrt-deployment-evaluation)
...
See the [runner setup](../../dev/benchmarks/reporting.md#opt-in-target-gpu-workflow).
...
succeeds and is documented. See the [history commands](../../dev/benchmarks/reporting.md#compact-report-history-and-local-dashboard).
