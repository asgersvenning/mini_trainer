...
try{
 ...
 for(let i=0;i<150;i++){if(await evaluate('typeof data!=="undefined" && !!document.getElementById("inference-load")'))break;await new Promise(r=>setTimeout(r,200));}
 if(errors.length)throw Error(JSON.stringify(errors));
 await evaluate('document.getElementById("inference-load").click()');
