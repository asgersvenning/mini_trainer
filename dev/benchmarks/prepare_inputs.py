...
def prepare(
    ...
    preprocess_factory="dev.benchmarks.prepare_inputs:repository_preprocess",
    factory_args=None,
    threads=1,
...
def main():
    ...
    parser.add_argument("--preprocess-factory", default="dev.benchmarks.prepare_inputs:repository_preprocess")
