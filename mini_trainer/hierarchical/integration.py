...
class HierarchicalBuilder(BaseBuilder):  # noqa: D101
    @staticmethod
    def class_spec(path: str | None = None, dir: str | None = None, levels: int | None = None, species: bool = True, *args, **kwargs):
        """TODO.
    ...
    def build_criterion(
        ...
        **kwargs,
        ...
        return MultiLevelWeightedCrossEntropyLoss(
            *args, class_frequencies=counts, device=device, dtype=dtype, loss_cls=EMLACrossEntropy, **kwargs
        )
